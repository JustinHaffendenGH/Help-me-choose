...
const curatedBooks = [
  // Contemporary Fiction
  {
    ...
    genre: 'Mystery',
    description:
      'A girl who raised herself in the marshes becomes a murder suspect.',
  },
  {
    title: 'Normal People',
    author: 'Sally Rooney',
    ...
    description:
      'Complex relationship between two Irish teenagers through school and university.',
  },
  {
  ...
  },
  {
    ...
    genre: 'Contemporary Fiction',
    description:
      'Twin sisters choose different worlds, affecting their daughters.',
  },
  {
  ...
  },
  {
    ...
    genre: 'Contemporary Fiction',
    description:
      'Four siblings throw a party that changes everything in 1983 Malibu.',
  },
  {
  ...
  },
  {
    ...
    genre: 'Fantasy',
    description:
      'A library where Nora explores different versions of her life.',
  },
  {
  ...
  },
  {
    ...
    genre: 'Romance',
    description:
      'Two writers challenge each other to write outside their genres.',
  },
  ...
  },
  {
    ...
    genre: 'Mystery',
    description:
      'Four friends investigate cold cases in their retirement community.',
  },
  ...
  // Children's Books
  {
    ...
    genre: "Children's",
    description:
      'A boy with facial differences starts mainstream school for the first time.',
  },
  {
  ...
  },
  {
    ...
    genre: "Children's",
    description:
      "Middle schooler Greg Heffley's hilarious adventures and misadventures.",
  },
  {
    ...
    genre: "Children's",
    description:
      'A robot stranded on an island learns to adapt and care for an orphaned gosling.',
  },
  {
    title: 'New Kid',
    author: 'Jerry Craft',
    ...
    genre: "Children's",
    description:
      'Graphic novel about a Black student navigating a new prep school.',
  },
  {
    ...
    genre: "Children's",
    description:
      'Five dragonets must fulfill an ancient prophecy to save their world.',
  },
  {
    title: 'Hatchet',
    author: 'Gary Paulsen',
    ...
    genre: "Children's",
    description:
      'A boy survives alone in the Canadian wilderness after a plane crash.',
  },
  {
    ...
    genre: "Children's",
    description:
      'A silverback gorilla tells his story of captivity and friendship.',
  },
  {
    title: 'Restart',
    ...
    genre: "Children's",
    description:
      'A boy with amnesia gets a chance to reinvent himself completely.',
  },
  {
    ...
    genre: "Children's",
    description:
      'A girl with dyslexia discovers her unique strengths and talents.',
  },
  {
    ...
    genre: "Children's",
    description:
      'A witch accidentally gives a baby magical powers in this fantasy tale.',
  },
  {
    title: 'Ghost',
    ...
    genre: "Children's",
    description:
      'A boy joins a track team and learns to run from his problems instead of away from them.',
  },
];
...
async function showRandomBook() {
  ...
  const promises = [getRandomGoogleBook(), getRandomOpenLibraryBook()];
...
const curatedFoods = [
  // Fast Food Chains
  {
    ...
    rating: 4.1,
    description:
      'World-famous fast food chain serving burgers, fries, chicken nuggets, and more. Open 24/7 with breakfast, lunch, and dinner options.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.0,
    description:
      'Kentucky Fried Chicken - Famous for their crispy fried chicken, mashed potatoes, coleslaw, and biscuits.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.0,
    description:
      'Home of the Whopper - Flame-grilled burgers, chicken sandwiches, fries, and onion rings.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.2,
    description:
      'Fresh submarine sandwiches made to order with your choice of meats, cheeses, vegetables, and sauces.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Pizza Chains
  {
    ...
    rating: 4.1,
    description:
      "America's favorite pizza with pan pizza, thin 'n crispy, hand-tossed, and specialty pizzas.",
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.2,
    description:
      'Fast pizza delivery with hand-tossed, thin crust, and deep dish pizzas. Famous for their 30-minute guarantee.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.3,
    description:
      'Better ingredients, better pizza - fresh dough, sauce from vine-ripened tomatoes, and quality cheese.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Chicken Chains
  {
    ...
    rating: 4.1,
    description:
      'Louisiana-style fried chicken, red beans and rice, jambalaya, and signature spicy chicken sandwiches.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.4,
    description:
      'Chicken sandwiches, waffle fries, nuggets, and milkshakes. Famous for their waffle-cut fries and polite service.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Coffee Chains
  {
    ...
    rating: 4.2,
    description:
      'Premium coffee, espresso drinks, pastries, sandwiches, and seasonal specials. Perfect for coffee lovers.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1559496417-e7f25cb247f3?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.1,
    description:
      "Donuts, coffee, bagels, breakfast sandwiches, and iced coffee. America's favorite all-day stop.",
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1559496417-e7f25cb247f3?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Mexican Chains
  {
    ...
    rating: 4.0,
    description:
      'Crunchwrap Supremes, burritos, tacos, nachos, and Mexican-inspired fast food favorites.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.3,
    description:
      'Build-your-own burritos, bowls, tacos, and salads with fresh ingredients and customizable options.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Sandwich Chains
  {
    ...
    rating: 4.2,
    description:
      'Artisan breads, soups, salads, sandwiches, and bakery items. Famous for their bread bowls and cafe atmosphere.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.1,
    description:
      'Gourmet sandwiches, wraps, and subs made fresh daily. Famous for their fast delivery and quality ingredients.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Ice Cream Chains
  {
    ...
    rating: 4.2,
    description:
      'Soft serve ice cream, Blizzards, cakes, burgers, fries, and Arctic Rush slushies.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.1,
    description:
      '31 flavors of ice cream, cakes, sundaes, and frozen treats. World-famous for their variety.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Asian Chains
  {
    ...
    rating: 4.0,
    description:
      'American Chinese cuisine with orange chicken, Beijing beef, fried rice, and chow mein.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1563379091339-03246963d7d7?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.3,
    description:
      'Upscale Chinese-American dining with dim sum, wok dishes, and Asian-inspired cuisine.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Breakfast Chains
  {
    ...
    rating: 4.1,
    description:
      'International House of Pancakes - Famous for pancakes, waffles, omelettes, and all-day breakfast.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 4.0,
    description:
      'All-day breakfast, burgers, sandwiches, and comfort food. Open 24/7 in many locations.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  // Seafood Chains
  {
    ...
    rating: 4.2,
    description:
      'Seafood restaurant with lobster, shrimp, fish, and signature Cheddar Bay Biscuits.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1559847844-5315695dadae?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
  ...
  },
  {
    ...
    rating: 3.9,
    description:
      'Fast seafood with fish, shrimp, clams, hushpuppies, and fries.',
    location: 'Multiple Locations',
    image:
      'https://images.unsplash.com/photo-1559847844-5315695dadae?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
...
function getRandomCuratedFood() {
  ...
  const mockLocation = { lat: 40.7128, lng: -74.006 }; // NYC as default
  ...
  return {
    ...
    image:
      'https://images.unsplash.com/photo-1551782450-17144efb9c50?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
...
async function getRandomGooglePlacesFood() {
  try {
    ...
    const location = foodCache.userLocation || { lat: 40.7128, lng: -74.006 }; // Default to NYC
    ...
    try {
      ...
      const priceParam =
        currentFoodFilter &&
        currentFoodFilter.price &&
        currentFoodFilter.price !== 'all'
          ? `&price=${encodeURIComponent(currentFoodFilter.price)}`
          : '';
      const resp = await fetch(
        `/api/nearby?lat=${encodeURIComponent(location.lat)}&lng=${encodeURIComponent(location.lng)}&radius=1500&type=restaurant${priceParam}`
      );
      if (resp.ok) {
        ...
        if (json && Array.isArray(json.results) && json.results.length > 0) {
          const mapped = json.results.map((r) => ({
            ...
            image: null,
            photo_reference:
              r.photos && r.photos[0] && r.photos[0].photo_reference
          ...
          try {
            console.log(
              'getRandomGooglePlacesFood - mapped sample:',
              mapped[0]
            );
          } catch (e) {
            // ignore
      ...
      console.warn(
        'Nearby proxy fetch failed, falling back to local generator:',
        proxyErr
      );
    }
  ...
  try {
    ...
    try {
      ...
      if (validFoods.length > 0) {
        ...
        const locationType = foodCache.userLocation
          ? '🎯 Using LOCAL'
          : '🏙️ Using MOCK LOCAL';
        console.log(
          locationType,
    ...
    if (!finalFood) {
      const mockLocation = { lat: 40.7128, lng: -74.006 }; // NYC as fallback
      const localRestaurants = generateLocalRestaurants(mockLocation);
      if (localRestaurants.length > 0) {
        finalFood =
          localRestaurants[Math.floor(Math.random() * localRestaurants.length)];
        console.log(
          '🏙️ Using FALLBACK local restaurant (mock location):',
          finalFood.title
        );
      }
    }
    ...
    // Trigger background preloading to keep cache full
    if (!foodCache.isPreloading && foodCache.google.length < 3) {
    ...
    if (localRestaurants.length > 0) {
      ...
      console.log(
        '🚨 Using EMERGENCY fallback local restaurant:',
        fallbackFood.title
      );
    }
  }
...
async function displayFoodWithLoadingSequence(food) {
  ...
  function getApiImageCandidates(item) {
    ...
    if (item.photo_reference) {
      ...
      candidates.push(
        `/api/photo?photoreference=${encodeURIComponent(item.photo_reference)}&maxwidth=1200`
      );
      ...
      if (key) {
        candidates.push(
          `https://maps.googleapis.com/maps/api/place/photo?maxwidth=1200&photoreference=${encodeURIComponent(item.photo_reference)}&key=${key}`
        );
      } else {
        console.warn(
          'Google Places photo_reference present but GOOGLE_PLACES_API_KEY not set on window. Proxy will be used if running.'
        );
      }
    }
  ...
  document.getElementById('food-price').textContent =
    `Price Range: ${priceVisual}`;

  // Add location indicator to show if it's local or curated
  const isLocal =
    food.place_id &&
    (food.place_id.startsWith('local_') || food.place_id.startsWith('yelp_'));
  ...
  try {
    console.log(`Cuisine: ${foodData.cuisine} • ${locationIndicator}`);
  } catch (e) {}
  ...
  if (foodImage) {
    ...
    const brandedFallbacks = {
      ...
      'pizza hut':
        'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      'burger king':
        'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      starbucks:
        'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      'taco bell':
        'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      subway:
        'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      dunkin:
        'https://images.unsplash.com/photo-1559496417-e7f25cb247f3?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      chipotle:
        'https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      domino:
        'https://images.unsplash.com/photo-1571066811602-716837d681de?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    };
    ...
    const cuisineFallbacks = {
      'Fast Food':
        'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      Chicken:
        'https://images.unsplash.com/photo-1513639776629-7b61b0ac49cb?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      Pizza:
        'https://images.unsplash.com/photo-1571066811602-716837d681de?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      Coffee:
        'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      ...
      Sandwiches:
        'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      'Ice Cream':
        'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      Chinese:
        'https://images.unsplash.com/photo-1563379091339-03246963d7d7?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
      Breakfast:
        'https://images.unsplash.com/photo-1551782450-17144efb9c50?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    ...
    if (cuisineFallbacks[foodData.cuisine])
      candidates.push(cuisineFallbacks[foodData.cuisine]);

    // Generic final fallback
    candidates.push(
      'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb'
    );
...
function getCurrencySymbolForPlace(place) {
  try {
    ...
    if (locale && locale.indexOf('-') !== -1) {
      ...
      if (
        ['DE', 'FR', 'ES', 'IT', 'NL', 'PT', 'IE', 'BE', 'AT', 'LU'].includes(
          region
        )
      )
        return '€';
...
function updateActiveFiltersDisplay() {
  try {
    ...
    if (cuisine && cuisine !== 'all')
      pills.push(
        `<span class="filter-pill">Cuisine: ${escapeHtml(String(cuisine))}</span>`
      );
    if (price && price !== 'all')
      pills.push(
        `<span class="filter-pill">Price: ${escapeHtml(String(price))}</span>`
      );
    if (pills.length === 0) {
  ...
  try {
        ...
        const filteredFoods = validFoods.filter((food) => {
          ...
          if (cuisine !== 'all') {
            ...
            if (food.matchedKeyword) {
              ...
              const matchesCuisineField = !!(
                food.cuisine && String(food.cuisine).toLowerCase().includes(c)
              );
              const matchesTypes = !!(
                food.types &&
                Array.isArray(food.types) &&
                food.types.some((type) =>
                  String(type).toLowerCase().includes(c)
                )
              );
              const matchesTitle = !!(
                food.title && String(food.title).toLowerCase().includes(c)
              );
          ...
          if (price !== 'all') {
            ...
            if (typeof food.price_level === 'number')
              numericFoodPrice = food.price_level;
            else if (typeof food.price === 'string')
              numericFoodPrice = food.price.replace(/[^$]/g, '').length || null;
            else if (typeof food.price === 'number')
              numericFoodPrice = food.price;
    ...
    if (!finalFood) {
      ...
      for (let i = 0; i < maxAttempts; i++) {
        ...
        if (cuisine !== 'all') {
          ...
          const matchesCuisine =
            !!(
              candidate.cuisine && candidate.cuisine.toLowerCase().includes(c)
            ) ||
            !!(candidate.title && candidate.title.toLowerCase().includes(c));
          if (!matchesCuisine) continue; // try another
        }

        // Price check
        if (price !== 'all') {
          const numericCandidatePrice =
            typeof candidate.price_level === 'number'
              ? candidate.price_level
              : typeof candidate.price === 'string'
                ? candidate.price.replace(/[^$]/g, '').length
                : null;
          const priceMap = { $: 1, $$: 2, $$$: 3, $$$$: 4 };
          const wanted = priceMap[price];
          if (!numericCandidatePrice || numericCandidatePrice !== wanted)
            continue;
        }
      ...
      if (found) finalFood = found;
        ...
        console.log(
          'No curated restaurants matched filters; showing a fallback result.'
        );
  ...
  const localChains = [
    {
      ...
      price: '$$',
      rating: 4.3,
      desc: 'Classic American grill with burgers, steaks, and local favorites.',
    },
    {
      ...
      price: '$$$',
      rating: 4.6,
      desc: 'Elegant French bistro featuring classic dishes and fine wines.',
    },
    {
      name: 'Metro Pizza Co.',
      cuisine: 'Pizza',
      price: '$$',
      rating: 4.4,
      desc: 'Authentic wood-fired pizzas with fresh local ingredients.',
    },
    {
      name: 'Urban Sushi',
      cuisine: 'Japanese',
      price: '$$$',
      rating: 4.5,
      desc: 'Fresh sushi and Japanese cuisine in the heart of the city.',
    },
    {
      name: 'Riverside Cafe',
      cuisine: 'Cafe',
      price: '$',
      rating: 4.2,
      desc: 'Cozy riverside cafe with great coffee and light meals.',
    },
    {
      name: 'Harbor Seafood',
      cuisine: 'Seafood',
      price: '$$$',
      rating: 4.7,
      desc: 'Fresh seafood dishes with ocean views and local catches.',
    },
    {
      name: 'Market Street BBQ',
      cuisine: 'BBQ',
      price: '$$',
      rating: 4.5,
      desc: 'Slow-smoked BBQ with authentic Southern flavors.',
    },
    {
      ...
      price: '$',
      rating: 4.1,
      desc: 'Local coffee shop with artisanal brews and pastries.',
    },
    {
      ...
      price: '$',
      rating: 4.0,
      desc: 'Gourmet burgers and fries with creative toppings.',
    },
    {
      name: 'Corner Thai',
      cuisine: 'Thai',
      price: '$$',
      rating: 4.3,
      desc: 'Authentic Thai cuisine with spicy curries and fresh herbs.',
    },
  ];
...
function getCuisineImage(cuisine) {
  const cuisineImages = {
    American:
      'https://images.unsplash.com/photo-1551782450-17144efb9c50?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    French:
      'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Pizza:
      'https://images.unsplash.com/photo-1571066811602-716837d681de?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Japanese:
      'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    ...
    Mexican:
      'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Healthy:
      'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Indian:
      'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Mediterranean:
      'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Chinese:
      'https://images.unsplash.com/photo-1563379091339-03246963d7d7?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    Italian:
      'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
...
async function getFilteredGooglePlacesFoods() {
  try {
    ...
    const keyword =
      currentFoodFilter &&
      currentFoodFilter.cuisine &&
      currentFoodFilter.cuisine !== 'all'
        ? `&keyword=${encodeURIComponent(currentFoodFilter.cuisine)}`
        : '';
    if (loc) {
      try {
        ...
        const priceParam =
          ...
          currentFoodFilter.price !== 'all'
            ...
            : '';
        const resp = await fetch(
          `/api/nearby?lat=${encodeURIComponent(loc.lat)}&lng=${encodeURIComponent(loc.lng)}&radius=1500&type=restaurant${keyword}${priceParam}`
        );
        if (resp.ok) {
          const json = await resp.json();
              ...
              const numericPrice =
                typeof r.price_level === 'number'
                  ...
                  : r.price_level
                    ...
                    : null;
              const priceString = numericPrice
                ? '$'.repeat(numericPrice)
                : r.price_level
                  ? String(r.price_level)
                  : '$$';
              return {
                title: r.name,
                description: r.vicinity || r.formatted_address || '',
        ...
        console.warn(
          'Filtered nearby proxy failed, falling back to mock list:',
          proxyErr
        );
      }
    }
    ...
    const localRestaurants = generateLocalRestaurants(
      foodCache.userLocation || { lat: 40.7128, lng: -74.006 }
    );
    const yelpRestaurants = generateYelpRestaurants(
      foodCache.userLocation || { lat: 40.7128, lng: -74.006 }
    );
    const allRestaurants = [...localRestaurants, ...yelpRestaurants];
...
async function updateLocationStatus() {
  ...
  try {
    ...
    if (foodCache.locationPermission && foodCache.userLocation) {
      try {
        console.log('Local restaurants available (location granted)');
      } catch (e) {}
    } else {
      try {
        console.log('Location access denied - using fallback restaurants');
      } catch (e) {}
    }
  } catch (error) {
    try {
      console.log(
        'Location access denied or error - using fallback restaurants'
      );
    } catch (e) {}
  }
}
